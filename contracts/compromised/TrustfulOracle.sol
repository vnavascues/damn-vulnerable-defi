...
contract TrustfulOracle is AccessControlEnumerable {
    ...
    // @audit this method is the only way of stealing the exchange funds performing an oracle attack.
    // To do so it is required to gain the TRUSTED_SOURCE_ROLE role
    function postPrice(
