...
contract ClimberTimelock is ClimberTimelockBase {
    ...
    function execute(
        ...
        for (uint8 i = 0; i < targets.length; ) {
            // @audit notes: possible attack to call UUPS-upgradeable functions and/or withdrawal ones
        ...
        // @audit bad checks-effects-interactions execution. This should be placed
