...
contract SelfiePool is ReentrancyGuard, IERC3156FlashLender {
    ...
    // @audit notice: there are no flash loan fees
    ...
    // @audit notice: withdrawing all the funds require being part of governance (pass the modifier).
    // @audit notice: it is the only way of withdrawing the funds.
